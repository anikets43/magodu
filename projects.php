	...
	<section id="pro-sec">
		<div class="container">
			<div class="row text-center" style="margin-top:-30px;">
					<div class="col-md-4 top-off">
							<div class="grid-image second-img">
									<img src="images/exam-img.jpg">
								</div>
								<div class="post-content">
										<h4 class="even">Coaching for Entrance Tests</h4>
										<hr class="even">
										<ul>
											<li>Providing coaching for Navodaya, degree, master degree & similar exams </li>
											<li>Providing coaching for competetive exams like Banking, Railways and Civil services exams</li>
				...
				<div class="col-md-4 top-off">
					<div class="grid-image">
						<img src="images/sports-img.jpg">
					</div>
					<div class="post-content">
						<h4 class="odd">Providing Sports Equipment</h4>
						<hr class="odd">
						<ul>
								<li>Providing sports equipment on needed basis, For eg, Badminton set, Chess boards, Carrom boards, Basket ball, Football etc.
								</li>
				...
				<div class="col-md-4 top-off">
						<div class="grid-image">
							<img src="images/library-img.jpg">
						</div>
						<div class="post-content">
							<h4 class="odd">Building a Library</h4>
							<hr class="odd">
							<ul>
									<li>Provide books which are not thought of before and also create better interest to learn faster & better </li>
